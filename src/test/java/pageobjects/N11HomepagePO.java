...
public class N11HomepagePO  {
    ...
    @FindBy(xpath = "//a[@href='//www.n11.com/hesabim'][contains(.,'Hesabım')]")
    private WebElement hesabimMenu;

    @FindBy(xpath = "//a[@href='//www.n11.com/hesabim/istek-listelerim']")
    private WebElement favorilerMenuItem;
...
//        driver.navigate().to(url);
    ...
    public void hoverOverHesabimMenu() throws InterruptedException {
        Actions act = new Actions(driver);
        act.moveToElement(hesabimMenu).perform();
        Thread.sleep(50);       //wait for menu animation
    }

    public void clickFavorilerimMenuItem(){
        Actions act = new Actions(driver);
        act.moveToElement(favorilerMenuItem).click().perform();
    }
